...
namespace Emanon\Library;


use Emanon\Constract\Configurable;
use Emanon\Core\Factory;
use Emanon\Library\Elasticsearch\Index;
use Emanon\Library\Elasticsearch\Result\IndexCreation;
use Emanon\Throwable\Library\Elasticsearch\IndexNotFoundException;
use Emanon\Throwable\Library\Elasticsearch\ResourceAlreadyExistsException;
use Emanon\Throwable\Library\ElasticsearchException;
...
class Elasticsearch implements Configurable
{
    ...
    public function preference(): array
    {
        return [
            ...
            'log_path' => NTS_RUNTIME_PATH . 'es/elasticsearch.log',
