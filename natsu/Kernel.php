...
use Emanon\Core\Command;
use Emanon\Throwable\Core\ClassInstantiationException;
use Emanon\Throwable\Core\ClassNotFoundException;
use ReflectionException;
use ReflectionClass;
use Emanon\Core\Dispatcher;
use Emanon\Core\Request;
use Emanon\Core\Route;
use Emanon\Core\Singleton;
use Emanon\Throwable\IO\File\NotFoundException as FileNotFoundException;
use Emanon\Throwable\IO\File\WriteException as FileWriteException;
use Emanon\Throwable\Validation\FormatException;
use Symfony\Component\Debug\ErrorHandler;
use Symfony\Component\Debug\ExceptionHandler;

define('NTS_BASE_PATH', __DIR__ . '/../');
define('NTS_RUNTIME_PATH', NTS_BASE_PATH . 'runtime/');
...
class Kernel
{
    ...
    private $config = [
        ...
        'session.save_path' => NTS_RUNTIME_PATH,# tcp://127.0.0.1:6379
     ...
     * @throws Throwable\Core\ActionNotFoundException
     * @throws Throwable\Core\ControllerNotFoundException
     * @throws Throwable\Core\ParameterNotFoundException
     */
